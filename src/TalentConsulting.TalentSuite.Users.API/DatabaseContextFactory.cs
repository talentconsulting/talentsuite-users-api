            ...
            case "UseSqlLite":
                {
                    ...
                    if (connectionString != null)
                        builder.UseSqlite(connectionString, b => b.MigrationsAssembly("TalentConsulting.TalentSuite.Users.API"));
                }
                break;
            case "UseSqlServerDatabase":
                {
                    var connectionString = configuration.GetConnectionString("DefaultConnection");
                    if (connectionString != null)
                        builder.UseSqlServer(connectionString, b => b.MigrationsAssembly("TalentConsulting.TalentSuite.Users.API"));
            ...
            case "UsePostgresDatabase":
                {
                    var connectionString = configuration.GetConnectionString("DefaultConnection");
                    if (connectionString != null)
                        builder.UseNpgsql(connectionString, b => b.MigrationsAssembly("TalentConsulting.TalentSuite.Users.API"));
